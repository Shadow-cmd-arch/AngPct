...
fenetre.title("AngPct   vers: 1.1")#________________________________________________________________________________________Titre de la fenêtre
...
bouton_effacer=Button(fenetre,text="Effacer le contenu",font=("Cylburn",15),bg="#c67242",fg="#000000",command=supr)
...
vers = Label(fenetre,text="Vers: 1.1",font=("Arial",15),fg="black",bg="#ffffff")
